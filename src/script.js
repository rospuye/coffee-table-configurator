...
const woodTextureBasePath = '/textures/wood_table/'
const woodTextureFiles = {
    ao: woodTextureBasePath + 'wood_table_001_ao_4k.jpg',
    arm: woodTextureBasePath + 'wood_table_001_arm_4k.jpg',
    diff: woodTextureBasePath + 'wood_table_001_diff_4k.jpg',
    disp: woodTextureBasePath + 'wood_table_001_disp_4k.png',
    normalEXR: woodTextureBasePath + 'wood_table_001_nor_gl_4k.exr',
    roughEXR: woodTextureBasePath + 'wood_table_001_rough_4k.exr'
}
const woodTextureMaps = {}

// load standard images
texLoader.load(woodTextureFiles.diff, t => {
    t.encoding = THREE.sRGBEncoding
    t.wrapS = t.wrapT = THREE.RepeatWrapping
    woodTextureMaps.map = t
})
texLoader.load(woodTextureFiles.ao, t => { t.wrapS = t.wrapT = THREE.RepeatWrapping; woodTextureMaps.aoMap = t })
texLoader.load(woodTextureFiles.disp, t => { t.wrapS = t.wrapT = THREE.RepeatWrapping; woodTextureMaps.displacementMap = t })
texLoader.load(woodTextureFiles.arm, t => { t.wrapS = t.wrapT = THREE.RepeatWrapping; woodTextureMaps.arm = t })

// load EXR maps
exrLoader.load(woodTextureFiles.normalEXR, tex => {
    tex.encoding = THREE.LinearEncoding
    tex.flipY = false
    woodTextureMaps.normalMap = tex
})
exrLoader.load(woodTextureFiles.roughEXR, tex => {
    tex.encoding = THREE.LinearEncoding
    tex.flipY = false
    woodTextureMaps.roughnessMap = tex
})
